      ...
      <hero className="flex flex-col">
        <header>
          <div className="container mx-auto flex flex-row items-center py-8 py-4">
            <logo>
              <a href="#">
                <Image src="/images/logo-asem.svg" width={200} height={56}></Image>
              </a>
            </logo>
            <nav className="flex-grow px-24">
              <ul className="flex justify-center text-white">
                ...
                <li className="px-2">
                  <a>Relatii internationale</a>
                  <ul>
                    <li><a></a></li>
                  </ul>
                </li>
                <separator></separator>
                <li className="px-2"><a>Student ASEM</a></li>
              </ul>
            </nav>
        ...
        <heroContent className="container mx-auto grid grid-cols-2 gap-4">
          ...
          <heroImg>
            <Image src="/" width={'auto'} height={'auto'}></Image>
          </heroImg>
        </heroContent>
      </hero>
      ...
      <partners>
        <div className="container mx-auto my-28 flex flex-col items-center justify-center">
          ...
          <ul className="grid grid-cols-4 gap-16 relative">
            <li className="flex my-4"><a style={{height: '80px', padding: '24px'}}><Image src="/images/partner-1.png" width={'auto'} height={56}></Image></a></li>
            <li className="flex my-4"><a style={{height: '80px', padding: '24px'}}><Image src="/images/partner-2.png" width={'auto'} height={56}></Image></a></li>
            <li className="flex my-4"><a style={{height: '80px', padding: '24px'}}><Image src="/images/partner-3.png" width={'auto'} height={56}></Image></a></li>
            <li className="flex my-4"><a style={{height: '80px', padding: '24px'}}><Image src="/images/partner-4.png" width={'auto'} height={56}></Image></a></li>
          </ul>
        </div>
      </partners>
          ...
          <div className="grid grid-cols-3 gap-8 mt-16">
            <div>
              <a className="relative flex items-end rounded-2xl shadow-xl transform transition-all hover:shadow-2xl hover:scale-105" style={{height:"300px", overflow: 'hidden'}} href="/">
                <div className="z-0">
                  <Image src="/images/faculty-1.png" layout="fill" objectFit="cover" objectPosition="center"></Image>
         .       </div>
            ...
            <div>
              <a className="relative flex items-end rounded-2xl shadow-xl transform transition-all hover:shadow-2xl hover:scale-105" style={{height:"300px", overflow: 'hidden'}} href="/">
                <div className="z-0">
                  <Image src="/images/faculty-2.png" layout="fill" objectFit="cover" objectPosition="center"></Image>
                </div>
            ...
            <div>
              <a className="relative flex items-end rounded-2xl shadow-xl transform transition-all hover:shadow-2xl hover:scale-105" style={{height:"300px", overflow: 'hidden'}} href="/">
                <div className="z-0">
                  <Image src="/images/faculty-3.png" layout="fill" objectFit="cover" objectPosition="center"></Image>
                </div>
            ...
            <div>
              <a className="relative flex items-end rounded-2xl shadow-xl transform transition-all hover:shadow-2xl hover:scale-105" style={{height:"300px", overflow: 'hidden'}} href="/">
                <div className="z-0">
                  <Image src="/images/faculty-4.png" layout="fill" objectFit="cover" objectPosition="center"></Image>
                </div>
            ...
            <div>
              <a className="relative flex items-end rounded-2xl shadow-xl transform transition-all hover:shadow-2xl hover:scale-105" style={{height:"300px", overflow: 'hidden'}} href="/">
                <div className="z-0">
                  <Image src="/images/faculty-5.png" layout="fill" objectFit="cover" objectPosition="center"></Image>
                </div>
            ...
            <div>
              <a className="relative flex items-end rounded-2xl shadow-xl transform transition-all hover:shadow-2xl hover:scale-105" style={{height:"300px", overflow: 'hidden'}} href="/">
                <div className="z-0">
                  <Image src="/images/faculty-6.png" layout="fill" ></Image>
                </div>
            ...
            <div className="col-span-8">
                <div className="flex flex-col">
                  <div className="relative flex items-end rounded-2xl shadow-xl mb-6" style={{height:"500px", overflow: 'hidden'}}>
                    <Image src="/images/main-article.png" layout="fill" objectFit="cover" objectPosition="center"></Image>
                  </div>
            ...
            <div className="col-span-4">
              <div className="flex flex-row mb-6">
                <div className="relative rounded-2xl mr-6 flex-shrink-0" style={{height: '150px', width: '150px', overflow: 'hidden'}}>
                  <Image src="/images/article-1.png" layout="fill" objectFit="cover" objectPosition="center"></Image>
                </div>
              ...
              <div className="flex flex-row mb-6">
                <div className="relative rounded-2xl mr-6 flex-shrink-0" style={{height: '150px', width: '150px', overflow: 'hidden'}}>
                  <Image src="/images/article-2.png" layout="fill" objectFit="cover" objectPosition="center"></Image>
                </div>
                <div className="flex flex-col justify-between">
                  <div>
              ...
              <div className="flex flex-row mb-6">
                <div className="relative rounded-2xl mr-6 flex-shrink-0" style={{height: '150px', width: '150px', overflow: 'hidden'}}>
                  <Image src="/images/article-3.png" layout="fill" objectFit="cover" objectPosition="center"></Image>
                </div>
                <div className="flex flex-col justify-between">
                  <div>
      ...
      <about>
        <div className="container mx-auto my-36">
          ...
          <div className="relative flex items-center rounded-2xl shadow-xl text-center my-6" style={{height:"525px", overflow: 'hidden'}} href="/">
            <div className="z-0">
              <Image src="/images/tour.png" layout="fill" objectFit="cover" objectPosition="center"></Image>
            </div>
      ...
      <testimonials>
        <div className="container mx-auto my-36">
          ...
          <div className="relative flex items-center rounded-2xl shadow-xl my-6 grid grid-cols-12" style={{height:"500px", overflow: 'hidden'}}>
            <div className="z-0">
              <Image src="/images/testimonial-1.png" layout="fill" objectFit="cover" objectPosition="end"></Image>
            </div>
          ...
          <div className="relative flex items-center rounded-2xl shadow-xl my-6 grid grid-cols-12" style={{height:"500px", overflow: 'hidden'}}>
            <div className="z-0">
              <Image src="/images/testimonial-2.png" layout="fill" objectFit="cover" objectPosition="end"></Image>
            </div>
